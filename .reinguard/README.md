...
| `policy/catalog.yaml` | Manual index of policy documents (`id`, `path`, `description`) |
...
| `control/catalog.yaml` | Manual index of control rule files (`id`, `path`, `type`, `description`) |
