...
| `--check-json` | no* | Inline JSON object for one check (repeatable). Use this when you need fields such as `evidence` without creating a temp file. |
...
- One-off evidence-rich checks: repeat `--check-json`
